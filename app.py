...
# --- RENDERIZADO SEGURO (ZERO-BUG FIX) ---
log_html = ""
for l in st.session_state.logs:
    ...
    # Todo en una sola línea para evitar bug de markdown
    log_html += f"<div class='log-row {l['c']}'><div class='log-ts'>{l['t']}</div><div>{msg_txt}</div></div>"

# Construcción final del HTML sin indentación interna peligrosa
console_html = f"""
